    ...
    function RegisterController() {
        ...
        _this.login = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, userApi.login({ user: this.account, pwd: this.password, guest: nav.guest })];
                    case 1:
                        retUser = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, userApi.setVerify(this.account, this.type, nav.oem)];
                    case 2:
                        ret = _a.sent();
...
var RegSuccess = /** @class */ (function (_super) {
    ...
    function RegSuccess() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.page = function () {
            var _a = _this.controller, account = _a.account, successText = _a.successText, login = _a.login;
