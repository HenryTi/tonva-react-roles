...
var QueryPager = /** @class */ (function (_super) {
    ...
    function QueryPager(query, pageSize, firstSize) {
    ...
    QueryPager.prototype.load = function (param, pageStart, pageSize) {
        return __awaiter(this, void 0, void 0, function () {
            var ret;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (pageStart === undefined)
                            pageStart = 0;
                        return [4 /*yield*/, this.query.page(param, pageStart, pageSize)];
                    case 1:
                        ret = _a.sent();
                        return [2 /*return*/, ret];
                }
    ...
    QueryPager.prototype.setPageStart = function (item) {
        ...
        if (order === undefined)
            return;
        var field = order.field, type = order.type, asc = order.asc;
        var start;
        if (item !== undefined)
            start = item[field];
        if (asc === false) {
...
var Query = /** @class */ (function (_super) {
    ...
    Query.prototype.pageCaller = function (params) {
    ...
    Query.prototype.page = function (params, pageStart, pageSize) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        p = { pageStart: pageStart, pageSize: pageSize + 1, params: params };
                        return [4 /*yield*/, this.pageCaller(p).request()];
                    case 1:
                        res = _a.sent();
    ...
    Query.prototype.queryCaller = function (params) {
    ...
    Query.prototype.query = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queryCaller(params).request()];
                    case 1:
                        res = _a.sent();
                        //let data = this.unpackReturns(res);
                        //return data;
