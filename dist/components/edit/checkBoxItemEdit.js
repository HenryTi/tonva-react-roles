...
var CheckBoxItemEdit = /** @class */ (function (_super) {
    ...
    function CheckBoxItemEdit() {
        ...
        _this.onChange = function (evt) {
            _this.newValue = _this.getValue(evt.target.checked);
            var preValue = _this.value;
            _this.isChanged = (_this.newValue !== preValue);
            _this.edit.onItemChanged(_this, _this.newValue);
        };
        return _this;
    }
    Object.defineProperty(CheckBoxItemEdit.prototype, "uiItem", {
        get: function () { return this._uiItem; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(CheckBoxItemEdit.prototype, "editInRow", {
        get: function () { return true; },
        enumerable: false,
        configurable: true
    });
    CheckBoxItemEdit.prototype.internalStart = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                uiItem = this.uiItem;
                if (uiItem === undefined)
                    return [2 /*return*/, this.input.checked];
                checked = this.input.checked;
                return [2 /*return*/, this.getValue(checked)];
            });
        });
    };
    CheckBoxItemEdit.prototype.end = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    CheckBoxItemEdit.prototype.renderContent = function () {
        var _this = this;
        var readOnly = this.uiItem.readOnly;
