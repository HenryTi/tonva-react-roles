...
exports.IdItemEdit = void 0;
var React = __importStar(require("react"));
var page_1 = require("../page/page");
var mobx_react_1 = require("mobx-react");
var itemEdit_1 = require("./itemEdit");
var IdItemEdit = /** @class */ (function (_super) {
    __extends(IdItemEdit, _super);
    function IdItemEdit() {
        ...
        _this.page = mobx_react_1.observer(function (props) {
            ...
            */
            return React.createElement(page_1.Page, { header: '更改' + _this.label }, "ddd");
        });
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    pickId = this.uiItem.pickId;
                                    if (pickId === undefined) {
                                        alert('IdItemEdit.pickId = undefined');
                                        return [2 /*return*/];
                                    }
                                    return [4 /*yield*/, pickId(undefined, undefined, this.value)];
                                case 1:
                                    boxId = _a.sent();
                                    //if (typeof id === 'object') {
                                    //    id = (id as any).id;
    ...
    IdItemEdit.prototype.internalEnd = function () {
