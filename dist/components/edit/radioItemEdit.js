...
var RadioItemEdit = /** @class */ (function (_super) {
    ...
    function RadioItemEdit(itemSchema, uiItem, label, value) {
        var _this = _super.call(this, itemSchema, uiItem, label, value) || this;
        ...
        _this.page = observer(function (props) {
            ...
            var right = React.createElement("button", { className: "btn btn-sm btn-success", disabled: !_this.isChanged, onClick: function () {
                    _this.verifyValue();
        ...
        if (_this.value === undefined) {
            _this.value = uiItem.defaultValue;
        }
        return _this;
    }
